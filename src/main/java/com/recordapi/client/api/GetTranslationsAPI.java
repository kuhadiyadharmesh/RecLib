...
//        param.add(new BasicNameValuePair("device_type",data.getDevice_type()));
        ...
        else
        {
            try
            {
                ...
                {
                    response_data = new GetTranslations_Response(jobj.getString("msg"),jobj.getJSONObject("translation").getString("Trash"),jobj.getJSONObject("translation").getString("All Files"));
