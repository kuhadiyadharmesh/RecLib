            ...
            try
            {
                if (jobj.getString("status").equals("ok"))
                {
                    ...
                    for (int i = 0; i < jar.length(); i++)
                    {
                       ...
                       // fo = new FileData(jo.getString("id"),"",jo.getString("name"),jo.getString("f_name"),jo.getString("l_name"),jo.getString("email"),jo.getString("phone"),jo.getString("notes"),jo.getString("source"),jo.getString("url"),jo.getString("credits"),jo.getString("duration"),jo.getString("time"),jo.getString("share_url"),jo.getString("download_url"),jo.getString("is_star"));
                       fo = new FileData(jo.getString("id"), jobj.getString("order_id"),jobj.getString("sid"),jo.getString("name"),jo.getString("f_name"),jo.getString("l_name"),jo.getString("email"),jo.getString("phone"),jo.getString("notes"),jo.getString("source"),jo.getString("url"),jo.getString("duration"),jo.getString("time"),jo.getString("share_url"),jo.getString("download_url"),jo.getString("is_star"));
                        fdata.add(fo);
                    }
